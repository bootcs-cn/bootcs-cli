...
from .conventions import get_source_filename, find_source_file
from .. import internal, c, java
    ...
    def __init__(self, problem: str, language: str = None):
        ...
        if language is None:
            raise ValueError(
                ...
                "Either pass language parameter or ensure internal.set_current_language() was called."
            )
