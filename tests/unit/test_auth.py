...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch(
            "bootcs.auth.credentials.get_credentials_path",
    ...
    def test_save_and_get_token(self):
        ...
        from bootcs.auth.credentials import save_token, get_token
    ...
    def test_clear_token(self):
        """Test clearing token."""
        from bootcs.auth.credentials import save_token, get_token, clear_token
    ...
    def test_save_and_get_user(self):
        ...
        from bootcs.auth.credentials import save_user, get_user
    ...
    def test_is_logged_in(self):
        ...
        from bootcs.auth.credentials import save_token, clear_token, is_logged_in
...
class TestDeviceFlow(unittest.TestCase):
    ...
    @patch("bootcs.auth.device_flow.requests.post")
    ...
    def test_start_device_flow_error(self, mock_post):
        ...
        from bootcs.auth.device_flow import start_device_flow, DeviceFlowError
